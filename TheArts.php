...
<html>
	...
	<body id="thearts" class="container-fluid">
            ...
            <div class="col-md-8 col-md-offset-2"><h3 class="text-info text-center">About Indian Dance Art Forms</h3>
                <!-- Tabs and Tab content -->
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#ClassicalArt" role="tab" data-toggle="tab">Classical Art forms</a></li>
                    <li><a href="#Bharatanatyam" role="tab" data-toggle="tab">Bharatanatyam</a></li>
                    <li><a href="#Mohiniattam" role="tab" data-toggle="tab">Mohiniattam</a></li>
                    <li><a href="#FolkDances" role="tab" data-toggle="tab">Folk Dances</a></li>					
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in" id="Bharatanatyam">
                        ...
                        <p>
                        <img title="Bharatanatyam pose" alt="Bharatanatyam pose" src="images/NehaWeb_15_cropped.jpg" style="float:left; margin-right:10px;"/>
                            Bharata Natyam dance is a form of Yoga - in the sense that it involves physical discipline and training to achieve perfection in form and is also the ultimate "yoga" or union with the God which needs true Bhakti (Devotion to God). <br />
                    ...
                    <div class="tab-pane fade in" id="Mohiniattam">
                        <h2 class="text-info text-center">Mohiniattam</h2>
                        <p>
                            <img title="Neha performing Mohiniattam" alt="Neha performing Mohiniattam" src="images/NehaMohiniAttam_03_WM.jpg" style="float:left; margin-right:10px;"/>Mohiniyattam, also spelt Mohiniattam  is a traditional South Indian dance from Kerala, developed by the Tamil nattuvanar (dance master) Vadivelu,one of the Thanjavur Quartet.<br /> 
                            It is a feminine dance form. The term Mohiniattam comes from the words "Mohini" meaning a woman who enchants onlookers and "aattam" meaning graceful and sensuous body movements.<br />  
                            The word "Mohiniattam" literally means "dance of the enchantress". This dance which has influences and elements from two South Indian dance forms, the Bharatanatyam and Kathakali, was formulated in the court of King Swati Tirunal by Vadivelu.<br />  
                            <img title="Mohiniattam pose"  alt="Mohiniattam pose" src="images/MohiniattamAtKresge2.jpg" style="float:right; margin-left:10px;"/>Here the movements of the dancer's body could be compared to the gently undulating palm fronds filling up the Kerala skyline.<br />  
                            There is a lot of heaving of the chest and swaying movements like the coconut palms. The gait and the stepping are reminiscent of a boat bobbing up and down in the gently soaring back waters of the kerala landscape, the land of Mohiniattam.<br />                         
                        </p>
                    </div>
					<div class="tab-pane fade in" id="FolkDances">
                        <h2 class="text-info text-center">Folk Dances of India</h2>
                        <p>
                            <img title="Laavani Folk dance of Maharashtra" alt="Laavani Folk dance of Maharashtra" src="images/Folkdances/Laavani.jpg" style="float:left; margin-right:10px;"/>Folk dance in India is a term broadly used to describe all forms of folk and tribal dances in regions across India. While Indian classical dance is considered a higher form of art and was practiced in courts, temples and on special occasions, folk dance forms are practiced in groups in rural areas as an expression of their daily work and rituals. They are performed on religious , seasonal festivals or entertainment. <br/>They reflect the traditional life and  cultural flavor of the life of the people of a certain country or region. Some of the popular folk dances that are performed across villages of India are are Bhangra, Garba, Ghummur, Laavni, Tamasha,  Bihu, and so on<br /><br />                        
                        </p>
                    </div>
                </div>
            </div>
